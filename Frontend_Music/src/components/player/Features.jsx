...
//   const {onToggleMute,onToggleLoop,onToggleSuffle,onChangeSpeed,onChangeVolume} = playerFeatures;
...
//         {/* Shuffle */}
//         <button type="button" className={shuffleEnabled ? "disabled shuffle":"enable shuffle"}
//         aria-label={shuffleEnabled ? "disable shuffle" : "enable shuffle"} onClick={onToggleSuffle}>
    ...
    <div className="features-root">
      <div className="features-row">
        ...
        <button
          type="button"
          className={
            shuffleEnabled ? "features-btn features-btn-active" : "features-btn"
          }
